...
| `com.sparta.msa_learning.config` | Config Server (중앙 설정 관리) | 18080 |
...
| [Config Server](docs/06-config-server.md) | 중앙 설정 관리, `@RefreshScope`, `/actuator/refresh`, bootstrap context |
